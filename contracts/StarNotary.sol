...
contract StarNotary is ERC721 {
    ...
    constructor(string memory name_, string memory symbol_) ERC721 ("Star Club", "STA") {}
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(ownerAddress1 != ownerAddress2, "You cannot exchange a Star with yourself.");
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(ownerOf(_tokenId) == msg.sender, "You cannot transfer a Star that you don't own");
